...
class _$LoginStateImpl implements _LoginState {
  const _$LoginStateImpl(
      {this.loading = RequestState.Init,
      this.loggedIn,
      this.errorMessage = ''});
  ...
  @override
  String toString() {
    return 'LoginState(loading: $loading, loggedIn: $loggedIn, errorMessage: $errorMessage)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, loading, loggedIn, errorMessage);
